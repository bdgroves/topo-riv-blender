...
In the example below, we will explain the workflow for making ***Figure 1*** (HUC8: 02050302, the Upper Juniata in Central Pennsylvania). This workflow is executed by running: `snakemake --cores 1 phase_2_visualize/out/render_02050302.png`. You can specify snakemake to make a rendered image of a HUC like this, but alternatively, you can change the list of outputs in `rule all` in the `Snakefile`. **Note**: For clarity, some of the additional parameters and files are omitted from the description below.
...
<div align="center">
    ...
    <p> <b>Figure 11</b>: <em>Example custom render of the Mt. Fuji.</em></p>
</div>

#### How do I iterate and improve your renders efficiently?
...
<div align="center">
    ...
    <p> <b>Figure 13</b>: <em>Adjusting the scale of the topography with the Blender GUI.</em></p>
</div>
...
<div align="center">
    ...
    <p> <b>Figure 14</b>: <em>Adjusting the lighting with the Blender GUI.</em></p>
</div>
